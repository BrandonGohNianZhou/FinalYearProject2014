...
// 2ステージのあたり判定用クラス			//
//	Per determination class of two-stage
// 制作日 : 2013/11/25					//
// 制作者 : Kouno Shin					//
//--------------------------------------//
...
{
	class StageCollisionPart2 : IStageCollision
    {
        #region PASS_SAFELY
		...
		{
			// Wall 1
			this.boardTexture[0].PosX = 14.0f;  // 37f
			this.boardTexture[0].PosY = stageCenterPoint.Y + 18.0f; //20
			this.boardTexture[0].PosZ = stageCenterPoint.Z + 230.0f;
            this.boardTexture[0].scaleX = 10.0f * 0.38f;
            this.boardTexture[0].scaleY = 15.0f + 1.0f;
			this.boardTexture[0].scaleZ = 4.0f;


			// Wall 2
			this.boardTexture[1].PosX = 0.0f;
			this.boardTexture[1].PosY = stageCenterPoint.Y + 0.5f;
			this.boardTexture[1].PosZ = stageCenterPoint.Z - 38.0f;
            this.boardTexture[1].scaleX = 60.0f * 0.4f;
            this.boardTexture[1].scaleY = 6.0f * 0.4f;
			this.boardTexture[1].scaleZ = 4.0f;

			
			// Wall 3
			this.boardTexture[2].PosX = 13.0f;  // 34f
			this.boardTexture[2].PosY = stageCenterPoint.Y + 0.5f;
			this.boardTexture[2].PosZ = stageCenterPoint.Z - 287.0f;
            this.boardTexture[2].scaleX = 10.0f * 0.4f;
            this.boardTexture[2].scaleY = 19.0f * 0.4f;
